...
`skill[i]` denotes the skill of the `i`th player. Divide the players
into `n / 2` teams of size 2 such that the total skill of each team is
equal.
...
It is always optimal to pair the weakest available player with the
