...
connected to every other city. The tourist's journey consists of exactly
k 0-indexed days, and they can choose any city as their starting point.
...
Output: 8
Explanation: The tourist earns the maximum number of points by starting in
city 1, staying in that city on day 0, and traveling to city 2 on day 1.
```
...
dp[i][j] is the maximum score that you can achieve in your last i actions by
starting from city j.
