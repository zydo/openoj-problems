...
These substrings cannot be rearranged to form t = "bbaacc", so the output
is false.
```
...
Split s into k equal-sized substrings, use a map to track frequencies,
and check if rearranging them can form t.
