...
is called a proper divisor of `x`. For example, 2 is a proper divisor of 4,
...
Input: nums = [25,7]
Output: 1
Explanation: Using a single operation, 25 gets divided by 5 and nums
becomes [5, 7].
```
...
Each number can be divided by its largest proper divisor to yield its
