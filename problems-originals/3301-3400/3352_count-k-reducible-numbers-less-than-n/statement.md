...
You can precompute the number of operations required to convert a number with `x` bits to `1`.

### Hint 2

Use digit DP to count the integers below `n` by their number of set bits.
