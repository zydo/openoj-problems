...
numbers `[minimum, maximum, mean, median, mode]`. Answers within `10⁻⁵`
...
The hard part is the median. Write a helper function which finds the
k-th element from the sample.
