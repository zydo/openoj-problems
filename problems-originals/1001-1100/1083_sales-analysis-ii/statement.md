...
product_id is the primary key (column with unique values) of this
table.
...
Write a solution to report the buyers who have bought S8 but not
iPhone. Note that S8 and iPhone are products presented in the Product
table.
