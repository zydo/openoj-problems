...
`x`, divided by the number of players whose install date is `x`, rounded
to 2 decimal places.

Write a solution to report for each install date, the number of players
...
logged back in on 2016-03-02 so the day 1 retention of 2016-03-01 is
1 / 2 = 0.50.
...
`install_dt`, `installs`, and `Day1_retention`.
