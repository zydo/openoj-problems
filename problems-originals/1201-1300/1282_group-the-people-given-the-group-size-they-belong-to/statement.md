...
You may return the answer in **any order**. The groups themselves and the
people inside each group may be listed in any order.
...
Put people's IDs with same groupSize into buckets, then split each bucket
into groups.
