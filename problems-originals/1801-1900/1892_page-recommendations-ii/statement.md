...
users `user1_id` and `user2_id` are friends.
...
unique values) for this table. Each row of this table indicates that
...
- `friends_likes`: The number of the friends of `user_id` that like
  `page_id`.
...
- User 1 only liked page 88, but user 6 already liked it. Hence, user 6
