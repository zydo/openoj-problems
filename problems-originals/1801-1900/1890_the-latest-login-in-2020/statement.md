...
(`user_id`, `time_stamp`) is the primary key (combination of columns
with unique values) for this table. Each row contains information about
...
once in December. We include only the latest one (December) in the
result table.
