...
The only way to change nums[0] to 1 is by performing an operation with
index i = 0.

### Hint 2

Iterate from left to right and perform an operation at each index i where
nums[i] is 0, and keep track of how many operations are currently
performed on the suffix.
