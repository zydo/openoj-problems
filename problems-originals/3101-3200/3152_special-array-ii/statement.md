...
Try to split the array into some non-intersected continuous special
subarrays.

### Hint 2

For each query check that the first and the last elements of that query are
in the same subarray or not.
