...
A city is composed of `n x n` blocks, where each block contains a single
...
`0`-height building can also be increased. However, increasing the height
of a building should not affect the city's skyline from any cardinal
direction.
...
Output: 35
Explanation: The grid after increasing the height of buildings without
