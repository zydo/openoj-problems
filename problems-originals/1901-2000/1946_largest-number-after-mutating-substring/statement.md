...
0-9 to another digit. More formally, digit `d` maps to digit `change[d]`.
...
If changing the first digit and the last digit both make the number bigger,
but you can only change one of them; which one should you change?
