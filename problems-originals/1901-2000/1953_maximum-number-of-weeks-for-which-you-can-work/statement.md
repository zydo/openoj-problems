...
Note that you cannot work on the last milestone of project 0 on 8th week
...
Work on the project with the largest number of milestones as long as it is
possible.

### Hint 2

Does the project with the largest number of milestones affect the number of
weeks?
