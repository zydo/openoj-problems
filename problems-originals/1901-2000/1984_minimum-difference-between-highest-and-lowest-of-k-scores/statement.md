...
the score of the `i`th student. You are also given an integer `k`.
...
For the difference between the highest and lowest element to be minimized,
...
After sorting the scores, any contiguous k scores are as close to each
other as possible.

### Hint 4

Apply a sliding window solution to iterate over each contiguous k scores,
