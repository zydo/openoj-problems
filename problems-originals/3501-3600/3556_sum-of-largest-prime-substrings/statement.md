...
If fewer than three exist, return the sum of all available primes. If no
prime numbers can be formed, return 0.
...
Store unique primes, then sum the three largest (or all if fewer than
three).
