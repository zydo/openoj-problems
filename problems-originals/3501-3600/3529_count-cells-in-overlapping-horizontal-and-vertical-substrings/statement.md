...
it wraps to the first row of the next column and continues as needed. You do
not wrap from the last column back to the first.
...
Use a string hashing or pattern matching algorithm to efficiently find all
horizontal and vertical occurrences of the pattern in the grid.

### Hint 2

Track the positions of each match and count only the cells that appear in both
