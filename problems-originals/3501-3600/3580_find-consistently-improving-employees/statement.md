...
`review_id` is the unique identifier for this table. Each row represents a
performance review for an employee. The rating is on a scale of 1-5 where 5
...
qualifying employee — the employee id, their name, and the improvement
score.
