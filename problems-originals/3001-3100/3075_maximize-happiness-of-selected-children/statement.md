...
Since all the unselected numbers are decreasing at the same rate, we should
greedily select k largest values.

### Hint 2

The ith largest number (i = 1, 2, 3,…k) should decrease by (i - 1) when it
is picked.
