...
If the total sum is not divisible by k, or the largest element exceeds the target, the partition is impossible.

### Hint 3

Use a bitmask of used elements to memoize the search and avoid re-exploring the same states.
