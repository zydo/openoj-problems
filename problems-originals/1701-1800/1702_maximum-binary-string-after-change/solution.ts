...
// Herding all z zeros into the first one (index first) parks the survivor
// at first + z - 1 with '1' everywhere else; with at most one zero no
// move can improve the string.
