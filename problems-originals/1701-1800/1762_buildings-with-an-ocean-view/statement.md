...
view if the building can see the ocean without obstructions.
Formally, a building has an ocean view if all the buildings to its
...
You can traverse the buildings from the nearest to the ocean to the
furthest.

### Hint 2

Keep with you the maximum to the right while traversing to determine
if you can see the ocean or not.
