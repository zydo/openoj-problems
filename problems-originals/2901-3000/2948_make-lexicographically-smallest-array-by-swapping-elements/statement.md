...
Sort nums. Now consecutive elements within limit belong to the same connected component, so all connected components become a list of position-consecutive elements after sorting.
