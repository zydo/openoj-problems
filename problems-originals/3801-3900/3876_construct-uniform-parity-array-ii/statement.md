...
Input: nums1 = [1,4,7]
Output: true
Explanation: Set nums2[0] = nums1[0] = 1.
...
the same parity. Thus, the answer is false.
```
...
Input: nums1 = [4,6]
Output: true
Explanation: Set nums2[0] = nums1[0] = 4.
...
Use the smallest odd/even element if a subtraction is needed to match the
chosen parity.
