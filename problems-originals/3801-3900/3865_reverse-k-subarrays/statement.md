...
Output: [2,1,3,4,6,5]
Explanation: The array is partitioned into k = 3 subarrays: [1, 2], [4, 3],
and [5, 6].
...
Output: [2,4,4,5]
Explanation: The array is partitioned into k = 1 subarray: [5, 4, 4, 2].
...
Reverse each subarray of size n / k.
