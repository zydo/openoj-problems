...
of tasks to be executed is four times the number of processors. Each task
must be assigned to a unique core, and each core can only be used once.
...
It’s optimal to make the processor with earlier process time run 4 longer
tasks.
