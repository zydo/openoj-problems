...
are simultaneously replaced with `"10"`. This process repeats until no
...
Perform the replacements simultaneously, and return the number of times the
process repeats.
