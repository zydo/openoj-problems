...
cells. You are given a positive integer n, indicating that you must do
the following routine for n minutes:
...
Derive a mathematical relation between total number of colored cells and
