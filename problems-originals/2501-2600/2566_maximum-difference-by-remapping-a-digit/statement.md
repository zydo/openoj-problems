...
Input: num = 11891
Output: 99009
Explanation: To achieve the maximum value, Bob can remap the digit 1 to
the digit 9 to yield 99899.
...
(if 0 is replaced by 9) and the minimum value that can be returned by the
