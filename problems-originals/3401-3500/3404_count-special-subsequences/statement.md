...
Count pairs where `nums[p] / nums[q]` equals `nums[s] / nums[r]`, using
GCD to handle ratios efficiently.

### Hint 2

Try iterating over `(p, q)` pairs and efficiently count valid `(r, s)`
