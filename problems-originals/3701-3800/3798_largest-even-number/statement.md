...
Input: s = "1112"
Output: "1112"
Explanation: The string already represents the largest possible even
number, so no deletions are needed.
```
...
Input: s = "221"
Output: "22"
Explanation: Deleting '1' results in the largest possible even number which
is equal to 22.
```
...
Find the last '2' in s. If none, return "". Otherwise return the prefix up
to and including that '2'.
