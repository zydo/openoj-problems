...
return to Digitville. The judge compares arrays exactly, so return the two
sneaky numbers in ascending order.
...
To solve the problem without the extra space, we need to think about how many
times each number occurs in relation to the index.
