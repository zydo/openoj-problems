...
class Solution:
    def scoreRange(self, weights: List[int], k: int) -> int:
        ...
        # weights[n-1] appear in every distribution's score, so they cancel in
        # the max-minus-min difference. Only the k-1 internal cuts matter:
