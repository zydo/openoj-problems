function reverseWholeList(head: ListNode | null): ListNode | null {
    // Depth is the hazard here: the judge's TS runtime caps the call stack
    ...
    function reverse(node: ListNode | null, n: number): ListNode | null {
