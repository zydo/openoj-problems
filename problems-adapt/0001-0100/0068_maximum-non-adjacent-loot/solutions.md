...
One recurrence, two directions of travel. Asking the question from the front
and letting it unfold, a cache stops the same suffix being solved twice;
reading left to right, two running numbers carry everything the next position
needs. Either way the relation being computed is
