class Solution {
    ...
    public int[] longestUniformRun(String s, String rewriteChars, int[] rewritePositions) {
        int n = s.length();
        ...
        int[] result = new int[rewritePositions.length];
        for (int i = 0; i < rewritePositions.length; i++) {
            update(
                chars,
                pref,
                suf,
