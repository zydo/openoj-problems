 ...
 * @return {number}
 */
var largestSumMinProduct = function (nums1, nums2, k) {
    ...
    // merged sweeps pairs in descending nums2 order (see stable sort above),
    // so when it reaches a pair, that pair's nums2 is the minimum of any set
    // drawn from pairs seen so far — the sweep enumerates the min provider.
    let total = 0;
    let best = 0;
