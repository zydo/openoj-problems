...
impl Solution {
    pub fn cheapest_apple_run(n: i32, roads: Vec<Vec<i32>>, apple_cost: Vec<i32>, k: i32) -> Vec<i32> {
        let n = n as usize;
        ...
        // apple_cost[j] + (k+1)*d(j) with d = shortest distance from start.
        for start in 1..=n {
