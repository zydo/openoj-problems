impl Solution {
    pub fn busiest_room(n: i32, meetings: Vec<Vec<i32>>) -> i32 {
        let n = n as usize;
        let mut ordered: Vec<(i32, i32, usize)> = meetings.iter().enumerate().map(|(i, m)| (m[0], m[1], i)).collect();
