# Solutions — The Knight's Round Trip

A sound round trip puts one visit number on every cell: visit `t`
records the cell occupied after `t` moves. Everything about validity
