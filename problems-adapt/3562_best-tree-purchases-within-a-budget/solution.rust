impl Solution {
    ...
    pub fn best_tree_purchases(n: i32, price: Vec<i32>, reward: Vec<i32>, edges: Vec<Vec<i32>>, budget: i32) -> i32 {
        let n = n as usize;
        ...
        for idx in (0..n).rev() {
            ...
            let cost_full = price[u] as usize;
            let cost_disc = (price[u] / 2) as usize;
            let profit_full = reward[u] - price[u];
            let profit_disc = reward[u] - price[u] / 2;
            for b in 0..=budget {
                if b >= cost_full {
