 ...
 * @return {number}
 */
var chooseIsolationII = function (graph, initial) {
    ...
    const touches = new Array(n).fill(0); // per root: distinct adjoining initial nodes
    const owner = new Array(n).fill(-1); // per root: the sole adjoining initial node
    ...
    const saved = new Array(n).fill(0);
