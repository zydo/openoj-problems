 ...
 * @return {number}
 */
var countCarvedRegions = function (grid) {
    // Blow every square up into a 3x3 block and paint its wall as blocked
    // pixels along the block's diagonal: '/' fills the anti-diagonal, '\'
    // the main diagonal, a blank fills nothing. Corner contacts survive the
