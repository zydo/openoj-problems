class Solution {
    ...
    public long richestRide(int[] lane1, int[] lane2) {
        final long NEG = Long.MIN_VALUE / 4; // sentinel far below any reachable value
        ...
        long[] prev1 = { NEG, NEG, NEG };
        long[] prev2 = { NEG, NEG, NEG };
        long best = NEG;
        for (int i = 0; i < n; i++) {
            long v1 = lane1[i];
            long v2 = lane2[i];
            long[] cur1 = { NEG, NEG, NEG };
            long[] cur2 = { NEG, NEG, NEG };
