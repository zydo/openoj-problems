...
//   InstanceProbe exposes the problem's one judged invocation: .obj is
//   the value handed to answersTo as its first argument and .cls
...
function buildClassTable(classes) {
    const table = new Map();
...
function materialize(table, desc, side) {
