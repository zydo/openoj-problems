// bundle-provided driver for 2676 pacing-the-calls. Assembled into every submission
...
class PaceProbe {
    ...
    drive(paceCalls: (fn: (...inputs: any[]) => void, t: number) => (...args: any[]) => void): void {
        ...
        try {
            ...
            const paced = paceCalls(fn, this.t);
            if (typeof paced !== "function") {
                throw new Error("paceCalls must return a function");
            }
            ...
            // paceCalls keeps at most one pending window at any moment, but
