...
impl Solution {
    pub fn last_crossable_day(row: i32, col: i32, cells: Vec<Vec<i32>>) -> i32 {
        ...
        while lo < hi {
            let mid = (lo + hi + 1) / 2; // upper mid: converge on last feasible
