impl Solution {
    pub fn max_non_overlapping_profit(start_time: Vec<i32>, end_time: Vec<i32>, profit: Vec<i32>) -> i32 {
        ...
        let mut jobs: Vec<(i32, i32, i32)> = (0..n).map(|i| (end_time[i], start_time[i], profit[i])).collect();
        jobs.sort();
