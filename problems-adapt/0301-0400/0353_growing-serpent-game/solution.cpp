...
// set of the cells it covers, each encoded as row * width + col; advance()
...
class SerpentGame {
  public:
    SerpentGame(int width, int height, vector<vector<int>> food) : width(width), height(height), food(std::move(food)) {
