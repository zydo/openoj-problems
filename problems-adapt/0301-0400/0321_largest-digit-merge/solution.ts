function buildLargestNumber(nums1: number[], nums2: number[], k: number): number[] {
    let best: number[] = [];
...
function maxSubsequence(nums: number[], t: number): number[] {
...
function larger(a: number[], b: number[]): boolean {
