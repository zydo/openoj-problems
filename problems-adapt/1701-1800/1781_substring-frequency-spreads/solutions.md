# Solutions — Substring Frequency Spreads

A substring's spread only compares the frequencies of the characters it
...
a single counter, and the substring's spread is that array's largest
...
once. Uniform and single-character substrings spread zero automatically:
