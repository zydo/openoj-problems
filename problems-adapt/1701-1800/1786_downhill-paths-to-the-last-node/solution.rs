...
impl Solution {
    pub fn count_downhill_paths(n: i32, edges: Vec<Vec<i32>>) -> i32 {
        // Dijkstra from node n fixes dist[x] = dist(x), the shortest distance to node n. A
        // downhill path strictly decreases that distance at every step,
