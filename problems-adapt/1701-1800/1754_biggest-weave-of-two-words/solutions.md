# Solutions — Biggest Weave of Two Words
...
On `("cb", "cba")` the heads tie on c and the suffix comparison
`"cb" < "cba"` sends the first take to word2 — the longer side — and
the weave ends `"ccbba"`. On `("azb", "aza")` the tie runs a, z
before `"azb" > "aza"` settles it in word1's favor. Full-tie inputs like `("z"*3000, "z"*3000)` simply
