# Solutions — Cutting Words At The Delimiter
...
Example 2's `"@mind@"` is really the three pieces `"", "mind", ""` around its
two `@` characters, so only `"mind"` survives. A word made entirely of
separators, such as Example 2's lone `"@"`, contributes nothing but empty
