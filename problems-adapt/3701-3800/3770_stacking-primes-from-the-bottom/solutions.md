# Solutions — Stacking Primes From The Bottom

The whole problem lives in one observation: a running total stacked from
the primes starting at 2 is just a prefix sum of the prime sequence. There are
