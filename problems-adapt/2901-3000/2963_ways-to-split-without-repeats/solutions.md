# Solutions — Ways To Split Without Repeats

No value may appear in two different pieces, so all occurrences of a
...
block would split some value across two pieces, while a cut between two
adjacent blocks is always safe. So the array decomposes into m maximal
blocks and a clean split is exactly a choice of which of the m - 1 gaps
