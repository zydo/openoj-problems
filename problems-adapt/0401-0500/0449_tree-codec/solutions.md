# Solutions — Tree Codec

## Preorder with null markers

`encode` walks the tree in preorder — the root, then its entire left
...
`decode` replays that walk with a stack of open child slots. The first
