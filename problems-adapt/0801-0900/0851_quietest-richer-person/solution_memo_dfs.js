 ...
 * @return {number[]}
 */
var quietestRicherPerson = function (richer, quiet) {
    // Each pair [a, b] is an edge from a richer person to a poorer one, so
    // the people definitely at least as rich as x are x plus all its
    ...
    const richerOf = Array.from({ length: n }, () => []);
