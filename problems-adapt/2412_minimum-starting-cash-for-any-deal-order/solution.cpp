class Solution {
  public:
    long long minimumStartingCash(vector<vector<int>> &deals) {
        long long total_drain = 0;
        long long max_rebate_losing = 0;
        long long max_price_winning = 0;
        for (auto &t : deals) {
            long long price = t[0], rebate = t[1];
