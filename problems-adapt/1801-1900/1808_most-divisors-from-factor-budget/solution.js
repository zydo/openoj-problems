...
var maxDivisorCount = function (primeFactors) {
    ...
    // The exponent reaches 10^9 / 3 and the product of two mod-reduced
    // residues reaches (10^9 + 6)^2 ~ 10^18, past the double's exact
    // 2^53 range, so the square-and-multiply runs on BigInt and converts
    // back only after the final reduction.
