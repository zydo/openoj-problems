...
impl Solution {
    pub fn plausible_roots(edges: Vec<Vec<i32>>, guesses: Vec<Vec<i32>>, k: i32) -> i32 {
        let n = edges.len() + 1;
        ...
        let guess_set: HashSet<i64> = guesses.iter().map(|g| key(g[0] as usize, g[1] as usize)).collect();
