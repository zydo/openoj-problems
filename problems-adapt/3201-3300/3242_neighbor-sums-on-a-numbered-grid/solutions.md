# Solutions — Neighbor Sums On A Numbered Grid
...
In example 2, value 15 sits at row 1, column 2, so `sideSum(15)` adds its
up, left, right, and down cells — 0, 7, 6, and 10 — for 23; value 9 sits at
row 2, column 1, and `cornerSum(9)` adds 4, 15, 12, and 14 for 45. The
