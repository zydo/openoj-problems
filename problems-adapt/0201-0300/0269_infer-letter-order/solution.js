 ...
 * @return {string}
 */
var inferLetterOrder = function (words) {
    const A = 26;
    const present = new Array(A).fill(false);
    ...
    const adj = Array.from({ length: A }, () => new Set());
    const indeg = new Array(A).fill(0);
    ...
    const done = new Array(A).fill(false);
    let order = "";
