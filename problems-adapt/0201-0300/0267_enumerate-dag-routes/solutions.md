...
_is_ a route, so take a snapshot of it — a copy, since the list is about to be
...
_supposed_ to share prefixes — a visited set would wrongly suppress the second
