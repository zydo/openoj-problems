...
that player chooses a node of their color (red if player 1, blue if player 2) and colors an uncolored neighbor of the chosen node (either the left
...
The best move `y` must be immediately adjacent to `x`, since it locks out
that subtree.
