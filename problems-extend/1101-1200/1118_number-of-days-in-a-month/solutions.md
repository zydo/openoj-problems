...
from a lookup: 31 days for months 1, 3, 5, 7, 8, 10, 12 and 30 for 4, 6, 9,
11. Only February varies, and it varies by exactly one day, so the whole
...
trap years come out right: 1900 is not a leap year (divisible by 100, not by
400) while 2000 is (divisible by 400).
