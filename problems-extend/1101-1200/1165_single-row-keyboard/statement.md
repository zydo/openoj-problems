...
Can the problem be divided in parts, so solving each part and summing their
solutions returns the answer? Yes, you only need to divide the problem in
finger jumps.

### Hint 2

In each finger jump you need to move your finger from one character to
another, you need to know its index.
