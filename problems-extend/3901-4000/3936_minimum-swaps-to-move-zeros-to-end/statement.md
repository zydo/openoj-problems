...
all `0`s to the end of the array.
...
Input: nums = [1,2,0]
Output: 0
Explanation: The array already satisfies the condition. Therefore, no swap
...
The values of non-zero elements do not matter. Convert the array to zeros and
ones.

### Hint 2

All ones that are in positions where a zero should be must be swapped out.
