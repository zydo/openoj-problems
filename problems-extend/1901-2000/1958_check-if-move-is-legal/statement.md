...
`'.'`, white cells are represented by `'W'`, and black cells are represented
by `'B'`.
...
To do that iterate over all directions horizontal, vertical, and diagonals
then check good lines naively
