// bundle-provided driver for 2627 debounce. Assembled into every
...
class DebounceCase {
    ...
    drive(debounce: (fn: (...inputs: any[]) => void, t: number) => (...args: any[]) => void): void {
        ...
        try {
            ...
            const debounced = debounce(fn, this.t);
            if (typeof debounced !== "function") {
                throw new Error("debounce must return a function");
            }
            ...
            // debounce schedules at most one timer per outstanding window,
