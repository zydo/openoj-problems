...
the 3rd types of cheese, and the second mouse eats the 0th and the 1st types
of cheese.
...
Imagine at first that the second mouse eats all the cheese, then we should
choose k types of cheese with the maximum sum of - reward2[i] + reward1[i].
