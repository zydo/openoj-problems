...
// statement's Input). drive() receives the submission's createHelloWorld
...
class HelloWorldCase {
    ...
    drive(createHelloWorld) {
        ...
        for (let at = 0; at < this.calls.length; at++) {
            this.outputs.push(sayHello(...this.calls[at]));
        }
    }
