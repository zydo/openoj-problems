...
Output: 3
Explanation: Bench 2 has two unique students: [1, 2].
...
Output: 3
Explanation: Bench 1 has three unique students: [1, 2, 3].
...
Output: 1
Explanation: The maximum number of unique students on a single bench is 1.
```
...
Input: students = []
Output: 0
Explanation: Since no students are present, the output is 0.
```
...
Use a hash table (or dictionary) to group students by their bench ID.
