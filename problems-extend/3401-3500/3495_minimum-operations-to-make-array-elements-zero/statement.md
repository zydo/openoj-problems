...
You are given a 2D array `queries`, where `queries[i]` is of the form
`[l, r]`. Each `queries[i]` defines an array of integers `nums` consisting of
...
all elements of the array to zero for each query. Return the sum of the
