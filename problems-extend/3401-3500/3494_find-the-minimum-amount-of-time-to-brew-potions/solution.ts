...
// binary-searches it with exact integer cross-multiplications. Every gap is
// at most ~1.25 * 10^11 and the accumulated time at most ~6.25 * 10^14 —
// both far below Number's 2^53 ceiling for exact integers, so plain number
// arithmetic is exact.
