...
myCalendarTwo.book(25, 55); // return True, The event can be booked, as the
                           ...
                           // third event, the time [40, 50) will be single
                           // booked, and the time [50, 55) will be double
...
Store two lists of intervals: one list will be all times that are at least
single booked, and another list will be all times that are definitely double
booked. If none of the double bookings conflict, then the booking will
succeed, and you should update your single and double bookings accordingly.
