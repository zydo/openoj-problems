...
Output: 6
Explanation: If we right shift nums1 2 times, it becomes [1, 2, 3, 1, 2, 3].
...
Output: 3
Explanation: If we right shift nums1 3 times, it becomes [5, 3, 1, 1, 4, 2].
...
Simulate the right shifts and check number of equal elements.
