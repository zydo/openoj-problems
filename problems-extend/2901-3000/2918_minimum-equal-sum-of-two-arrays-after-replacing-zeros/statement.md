...
Consider we replace all the 0’s with 1’s on both arrays, the answer will be
-1 if there was no 0 in the array with the smaller sum of elements.

### Hint 2

Otherwise, how can you update the value of exactly one of these 1’s to make
the sum of the two arrays equal?
