...
Output: [[2]]
Explanation: There is only one possible k x k submatrix: [[1, 8], [3, -2]].
...
Input: grid = [[3,-1]], k = 1
Output: [[0,0]]
Explanation: Both k x k submatrix has only one distinct element.
...
Output: [[1,2]]
Explanation: There are two possible k × k submatrix:
