...
the set of denominations that could have resulted in the given `numWays`
array.

Return a sorted array containing unique integers which represents this set of
denominations.
...
Output: [2,4,6]
Explanation: Each row shows the number of ways for that amount and how they
are formed.
...
10 | 5 | The ways are [2, 2, 2, 2, 2], [2, 2, 2, 4], [2, 4, 4], [2, 2, 6],
and [4, 6].
```
