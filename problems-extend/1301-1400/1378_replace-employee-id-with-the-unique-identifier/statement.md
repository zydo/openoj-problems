...
| 1         | Jonathan |
+-----------+----------+
Explanation: Alice and Bob do not have a unique ID, so null is shown instead.
The unique ID of Meir is 2. The unique ID of Winston is 3. The unique ID of
Jonathan is 1.
```
