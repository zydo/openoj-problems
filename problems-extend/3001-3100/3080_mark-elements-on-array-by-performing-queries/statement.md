...
- Then mark `k_i` unmarked elements in the array with the smallest values. If
  ...
  if less than `k_i` unmarked elements exist, then mark all of them.
...
Sort the array nums to be able to find the smallest unmarked elements quickly
in each query.
