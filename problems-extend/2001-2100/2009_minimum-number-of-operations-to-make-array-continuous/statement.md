...
For example, `nums = [4, 2, 5, 3]` is continuous, but
...
For every index do a binary search to get the possible right end of the window
and calculate the possible answer.
