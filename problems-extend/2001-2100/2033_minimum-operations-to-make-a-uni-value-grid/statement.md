...
Is it possible to make two integers `a` and `b` equal if they have different
remainders dividing by `x`?

### Hint 2

If it is possible, which number should you select to minimize the number of
operations?
