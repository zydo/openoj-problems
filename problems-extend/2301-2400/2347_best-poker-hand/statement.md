...
have 5 cards where the ith card has a rank of `ranks[i]` and a suit of
`suits[i]`.
...
Sequentially check the conditions 1 through 4, and return the outcome
corresponding to the first met condition.
