...
We represent the search state as `(player_row, player_col, box_row,
box_col)`.

### Hint 2

You need to count only the number of pushes. Then inside your BFS check if the
box could be pushed (in any direction) given the current position of the
player.
