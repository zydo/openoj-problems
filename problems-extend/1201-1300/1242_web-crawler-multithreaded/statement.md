...
multi-threaded web crawler to crawl all links that are under the same hostname
as `startUrl`.
...
within 15ms. Single-threaded solutions will exceed the time limit so, can your
...
- Assume we have 10,000 nodes and 1 billion URLs to crawl. We will deploy the
  ...
  have to minimize communication between machines and make sure each node
  does equal amount of work. How would your web crawler design change?
