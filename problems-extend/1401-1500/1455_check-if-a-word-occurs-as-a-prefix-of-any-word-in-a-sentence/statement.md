...
Check for each word if `searchWord` occurs at index 0, if so return the
index of this word (1-indexed).

### Hint 3

If `searchWord` doesn't exist as a prefix of any word return the default
value (-1).
