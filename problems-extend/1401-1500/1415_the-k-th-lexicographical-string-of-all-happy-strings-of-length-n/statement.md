...
happy strings and strings `"aa"`, `"baa"` and `"ababbc"` are not happy
strings.
...
Input: n = 3, k = 9
Output: "cab"
Explanation: There are 12 different happy strings of length 3 ["aba",
...
Sort them in lexicographical order and return the kth string if it
exists.
