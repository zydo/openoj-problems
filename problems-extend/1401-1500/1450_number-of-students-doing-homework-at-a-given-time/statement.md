...
2 and also wasn't doing anything at time 4.
...
Imagine that `startTime[i]` and `endTime[i]` form an interval (i.e.,
`[startTime[i], endTime[i]]`).

### Hint 2

The answer is how many times the `queryTime` laid in those mentioned
intervals.
