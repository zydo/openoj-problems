...
You are given a positive integer `n` representing the number of nodes of
a Directed Acyclic Graph (DAG). The nodes are numbered from `0` to
`n - 1` (inclusive).
...
How can performing BFS/DFS on the reversed graph help us find the
