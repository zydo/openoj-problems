...
containing the words denoting positive and negative feedback,
respectively. Note that no word is both positive and negative.
...
non-increasing order by their points. In case more than one student has
...
- Both positive_feedback[i] and negative_feedback[j] consists of
