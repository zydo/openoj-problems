...
Output: 6
Explanation: The sequence a = [0, 2, 4, 1, 2, 6, 2, 1, 1, 3] satisfies the
given constraints (a[3] <= 1 and a[8] <= 1).
...
Output: 12
Explanation: The sequence a = [0, 3, 3, 2, 6, 8, 11, 12] satisfies the given
constraints (a[3] <= 2).
...
Any restriction at index i also indirectly limits nearby positions due to the cumulative diff bounds.
