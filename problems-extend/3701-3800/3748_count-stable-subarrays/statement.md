...
Explanation:
    ...
    [3, 1, 2].
        The stable subarrays are [3], [1], [2], and [1, 2]. The total number
        of stable subarrays is 4.
Thus, ans = [2, 3, 4].
```
...
Identify maximal non-decreasing segments. Each segment of length L contributes
L * (L + 1) / 2 stable subarrays.
...
For query `[l, r]`, compute the prefix sum in the range and adjust for the
left segment crossing `l`.
