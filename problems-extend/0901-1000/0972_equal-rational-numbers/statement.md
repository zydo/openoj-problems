...
Output: true
Explanation: "0.(52)" represents 0.52525252..., and "0.5(25)" represents
0.5252525252..., so the strings represent the same number.
```
...
equals 1. "1." represents the number 1, which is formed correctly:
