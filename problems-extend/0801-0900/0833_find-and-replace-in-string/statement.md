...
You are given a 0-indexed string `s` on which you must perform `k`
replacement operations. The replacement operations are given as three
0-indexed parallel arrays `indices`, `sources`, and `targets`, all of
length `k`.
