...
If she erases 1, the board becomes [1, 2], whose bitwise XOR is
1 XOR 2 = 3. Bob can then remove any element he wants, because Alice will
be the one to erase the last element and she will lose.
If Alice erases 2 first, the board becomes [1, 1], whose bitwise XOR is
1 XOR 1 = 0, so Alice loses.
```
