...
Output: 2
Explanation: The 4th smallest wonderful number is "5489355421". To get
this number:
...
Input: num = "00123", k = 1
Output: 1
Explanation: The 1st smallest wonderful number is "00132". To get this
number:
...
Try to move each element to its correct position and calculate the number
of steps.
