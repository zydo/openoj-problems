...
At a given point, there are only 3 possible states for where the frog can
be.

### Hint 2

Check all the ways to move from one point to the next and update the
minimum side jumps for each lane.
