...
Explanation: Sort the words in s to their original positions "This1 is2
a3 sentence4", then remove the numbers.
```
...
Sort the words by removing the last character from each word and sorting
according to it
