...
product sum if you are allowed to rearrange the order of the elements in
`nums1`.
...
Is there a particular way we should order the arrays such that the
product sum is minimized?

### Hint 2

Would you want to multiply two numbers that are closer to one another or
further?
