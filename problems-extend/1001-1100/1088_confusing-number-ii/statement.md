...
- For example, after rotating `8000`, we have `0008` which is considered
  as just `8`.
...
Only `0`, `1`, `6`, `8`, `9` are the valid set of digits, do a
backtracking to generate all the numbers containing this digits and
