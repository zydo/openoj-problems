...
[1,1,0,1]` represents the number `(-2)^3 + (-2)^2 + (-2)^0 = -3`. A
number `arr` in array format is also guaranteed to have no leading
...
We can try to determine the last digit of the answer, then divide
everything by 2 and repeat.
