...
the ball falls out of at the bottom after dropping the ball from the `i`-th
...
Output: [1,-1,-1,-1,-1]
Explanation: Ball b0 is dropped at column 0 and falls out of the box at
column 1.
Ball b1 is dropped at column 1 and gets stuck in the box between columns 2
and 3 and row 1.
Ball b2 is dropped at column 2 and gets stuck in the box between columns 2
and 3 and row 0.
Ball b3 is dropped at column 3 and gets stuck in the box between columns 2
and 3 and row 0.
Ball b4 is dropped at column 4 and gets stuck in the box between columns 2
and 3 and row 1.
```
...
Traverse the path of the ball downwards until you reach the bottom or get
stuck.
