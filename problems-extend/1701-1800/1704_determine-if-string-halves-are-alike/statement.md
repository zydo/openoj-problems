...
Split this string into two halves of equal lengths, and let `a` be the first
half and `b` the second half.
...
Create a function that checks if a character is a vowel, either uppercase
or lowercase.
