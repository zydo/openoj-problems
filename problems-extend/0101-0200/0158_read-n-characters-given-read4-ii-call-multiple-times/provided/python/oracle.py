...
character the solution has consumed. The judge also hands the constructor
the case's buffer capacity (the driver-side allocation for the out buffer);
the file itself ignores it.
"""


class File:
    def __init__(self, content: list[str], capacity: int, budget: int):
