...
`artifacts[i] = [r1i, c1i, r2i, c2i]` denotes that the `i`th artifact is
buried in the subgrid where:
...
Check if each coordinate of each artifact has been excavated. How can we do
this quickly without iterating over the dig array every time?
