...
to be the sum of all its preceding elements plus the element itself. For
...
Input: n = 4, k = 5
Output: 56
Explanation: Each row shows the array after that many seconds.
Second | State After
   0   | [1,1,1,1]
   1   | [1,2,3,4]
   2   | [1,3,6,10]
...
Calculate the prefix sum array of nums, k times.
