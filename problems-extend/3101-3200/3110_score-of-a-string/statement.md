...
|104 - 101| + |101 - 108| + |108 - 108| + |108 - 111| = 3 + 7 + 0 + 3 =
13.
```
...
'a' = 97. So, the score of s would be |122 - 97| + |97 - 122| = 25 + 25
= 50.
```
...
Sum the difference between all the adjacent characters by just taking
