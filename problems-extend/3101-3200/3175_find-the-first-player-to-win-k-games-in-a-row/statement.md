...
All players are standing in a queue in order from player 0 to player
`n - 1`.
...
Suppose that k ≥ n, there is exactly one player who can win k games in a row. Who is it?

### Hint 2

In case `k < n`, you can simulate the competition process described.
