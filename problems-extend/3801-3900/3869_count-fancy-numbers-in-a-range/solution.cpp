...
class Solution {
  ...
  private:
    ...
    long long countUpTo(long long x, const vector<long long>& goods,
                        const vector<int>& good, const vector<long long>& overlap) {
    ...
    long long countOverlap(long long x, const vector<long long>& goods,
