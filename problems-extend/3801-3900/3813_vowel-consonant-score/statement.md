...
You are given a string s consisting of lowercase English letters, spaces, and
digits.
...
Input: s = "cooear"
Output: 2
Explanation: The string s = "cooear" contains v = 4 vowels ('o', 'o', 'e',
'a') and c = 2 consonants ('c', 'r').
...
Input: s = "axeyizou"
Output: 1
Explanation: The string s = "axeyizou" contains v = 5 vowels ('a', 'e',
'i', 'o', 'u') and c = 3 consonants ('x', 'y', 'z').
...
Input: s = "au 123"
Output: 0
Explanation: The string s = "au 123" contains no consonants (c = 0), so the
score is 0.
```
