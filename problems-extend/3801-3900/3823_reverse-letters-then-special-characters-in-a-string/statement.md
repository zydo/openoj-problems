...
You are given a string s consisting of lowercase English letters and special
characters.
...
Input: s = "z"
Output: "z"
Explanation: The string contains only one letter, and reversing it does not
...
Input: s = "!@#$%^&*()"
Output: ")(*&^%$#@!"
Explanation: The string contains no letters. The string contains all special
characters, so reversing the special characters reverses the whole string.
```
...
Use two pointers from ends, skipping non-letters.

### Hint 2

Use two pointers from ends, skipping letters.
