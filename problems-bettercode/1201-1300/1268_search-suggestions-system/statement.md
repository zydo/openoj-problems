...
a common prefix with `searchWord`. If there are more than three products with
...
Brute force is a good choice because the length of the string is at most 1000.
...
Use a trie data structure to store the best three matching products, then traverse the trie.
