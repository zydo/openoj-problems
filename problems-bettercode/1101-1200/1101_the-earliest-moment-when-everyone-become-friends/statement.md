...
Use a union-find data structure over the n people, starting with no edges.

### Hint 3

Loop through the events and unite nodes until the number of connected components reaches 1; that union's timestamp is the answer.
