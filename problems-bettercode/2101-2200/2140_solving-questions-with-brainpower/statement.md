...
For each question, we can either solve it or skip it. How can we use Dynamic Programming to decide the most optimal option for each question?

### Hint 2

Store for each question the maximum points we can earn if we started the exam on that question.

### Hint 3

If we skip a question, then the answer for it is the same as the answer for the next question.

### Hint 4

If we solve a question, then the answer for it is the points of the current question plus the answer for the next solvable question.
