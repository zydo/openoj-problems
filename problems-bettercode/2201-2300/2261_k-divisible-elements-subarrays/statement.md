...
are: [2], [2,3], [2,3,3], [2,3,3,2], [3], [3,3], [3,3,2], [3,3,2,2], [3,2],
[3,2,2], and [2,2].
...
Output: 10
Explanation: All elements of nums are divisible by p = 1.
...
Use any suitable method to hash the subarrays to avoid counting duplicates.
