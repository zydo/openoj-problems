## 163 — Fair Distribution of Cookies

- New id / title / slug: 163 / Smallest Largest Group Sum / `smallest-largest-group-sum`
...
- Statement rewritten from spec: yes — cookies/children scenario dropped; framed as grouping entries into `k` groups and minimizing the largest group sum (sibling of `0161_smallest-largest-split-sum`, which is the contiguous variant — titles kept recognizably parallel, method names likewise)
