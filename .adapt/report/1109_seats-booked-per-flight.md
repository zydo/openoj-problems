...
- New id / title / slug: 1109 / Seats Booked per Flight / `seats-booked-per-flight`
...
- Figures: none
- Gates: check ✓ (tree run) verify ✓ (7/7 languages, 14/14 cases) sandbox n/a compatibility ✓ stale ✓ overlap ✓
