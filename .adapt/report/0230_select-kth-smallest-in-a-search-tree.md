...
- New id / title / slug: 230 / Select Kth Smallest In A Search Tree / `select-kth-smallest-in-a-search-tree`
...
- Title keeps kinship with `0215_select-kth-largest` (Select Kth Largest).
