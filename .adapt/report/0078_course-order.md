## 78 — Course Schedule II

- New id / title / slug: 78 / Course Order / `course-order`
...
- Statement rewritten from spec: yes — first paragraph identical to `0077_course-feasibility`'s, so the pair reads as one programme; the ask is a sequence, "any sequence that respects the rules is accepted"
...
- **Family: `course`, written straight after `0077_course-feasibility`.** The
