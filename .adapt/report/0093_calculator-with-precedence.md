## 93 — Basic Calculator II

- New id / title / slug: 93 / Calculator With Precedence / `calculator-with-precedence`
...
- **Family: `calc`, written straight after `0092_calculator-with-parentheses`.**
