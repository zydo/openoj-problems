## 697 — Robot Collisions

- New id / title / slug: 697 / Line Collision Survivors / `line-collision-survivors`
...
- `check.py --tree problems-adapt --skip-runtime` still reports 8 failures in
  `0240_interpret-scoped-expression` (starters not generator output) — a
