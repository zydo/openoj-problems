...
- New id / title / slug: 2064 / Smallest Largest Bin Load / `smallest-largest-bin-load`
...
- Figures: none
- Family: follows the `smallest-largest-*` title branch (`0410_smallest-largest-split-sum`, `2305_smallest-largest-group-sum`); the one-pile-per-bin rule keeps it distinct from those
