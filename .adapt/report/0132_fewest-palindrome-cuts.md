...
- New id / title / slug: 132 / Fewest Palindrome Cuts / `fewest-palindrome-cuts`
...
- Statement rewritten from spec: yes — inherits `0131_palindrome-partitions`' framing (consecutive **pieces** that "read the same in both directions") and adds the counting question
...
- **Family: `palin-part`, written straight after `0131_palindrome-partitions`.**
