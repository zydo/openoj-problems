## 87 — Kth Smallest Product of Two Sorted Arrays

- New id / title / slug: 87 / Kth Smallest Pair Product / `kth-smallest-pair-product`
...
- Figures: none
- Family: kth-order-statistic names (`0085_kth-smallest-gap`, `0086_kth-least-subarray-sum`, `0084_select-kth-largest`) — this one follows the `kth-smallest-*` branch
