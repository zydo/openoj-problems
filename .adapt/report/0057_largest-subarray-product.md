...
- New id / title / slug: 57 / Largest Subarray Product / `largest-subarray-product`
...
- Sibling of `0023_largest-subarray-sum`: the title is the deliberate parallel,
...
- The tree-wide `check.py` run at this point reported one failure in
  `0054_cycle-entry-in-a-list`, a bundle from another chunk that was mid-write;
