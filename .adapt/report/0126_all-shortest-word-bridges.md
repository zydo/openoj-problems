...
- New id / title / slug: 126 / All Shortest Word Bridges / `all-shortest-word-bridges`
...
- Statement rewritten from spec: yes — the bridge/neighbour definitions are copied verbatim from the finished sibling `0127_shortest-word-bridge` so the pair reads as one family, with only the ask differing
...
- **Family: `ladder`, written straight after `0127_shortest-word-bridge`.** The
