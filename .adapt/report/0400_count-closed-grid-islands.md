## 400 — Number of Closed Islands

- New id / title / slug: 400 / Count Closed Grid Islands / `count-closed-grid-islands`
...
- Title kin to `0071_count-grid-islands` / `0072_count-grid-islands-land-updates`.
