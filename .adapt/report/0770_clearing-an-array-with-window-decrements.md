## 770 — Zero Array Transformation I

- New id / title / slug: 770 / Clearing an Array with Window Decrements / `clearing-an-array-with-window-decrements`
...
- The bank holds no 3356/3357 siblings, so the "I" suffix was dropped
  without kinship concerns. `0698_zero-array-with-fixed-windows` already
