...
- New id / title / slug: 2560 / Non-Adjacent Loot Under a Cap / `non-adjacent-loot-under-a-cap`
...
- Figures: none
- Family: `house-robber` — part I `0198_maximum-non-adjacent-loot`, part III `0337_non-adjacent-loot-in-a-tree` (both on disk), this is part IV. Part II `0213_house-robber-ii` is still unadapted
