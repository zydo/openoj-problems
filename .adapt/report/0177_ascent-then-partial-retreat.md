...
- New id / title / slug: 177 / Ascent Then Partial Retreat / `ascent-then-partial-retreat`
...
- **Gate limitation, pre-existing:** when a source's rust entrypoint equals
  ...
  already affects `0068_maximum-non-adjacent-loot` and
  `0045_palindrome-partitions`, which fail the gate today. Workaround used
