## 81 — Design Add and Search Words Data Structure

- New id / title / slug: 81 / Wildcard Word Lookup / `wildcard-word-lookup`
...
- Kin naming with `0079_prefix-tree`: the two are trie siblings (not a
