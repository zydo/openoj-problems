...
- New id / title / slug: 698 / Split Into K Equal-Sum Groups / `split-into-k-equal-sum-groups`
...
- Sibling naming: `0416_split-into-equal-sum-halves` (from Partition Equal Subset
