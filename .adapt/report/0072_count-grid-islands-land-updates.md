## 72 — Number of Islands II

- New id / title / slug: 72 / Count Grid Islands, Land Updates / `count-grid-islands-land-updates`
...
- **Family: `islands`, written straight after `0071_count-grid-islands`.** The
