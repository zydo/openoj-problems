## 356 — Parsing A Boolean Expression

- New id / title / slug: 356 / Evaluate a Boolean Formula / `evaluate-a-boolean-formula`
...
- Figures: none
- Gates: check ✓ (bundle shape; central tree run pending) verify ✓ (7/7 languages, 19/19 cases) sandbox n/a compatibility ✓ stale ✓ overlap ✓
