...
- New id / title / slug: 1810 / Cheapest Route in a Hidden Maze / `cheapest-route-in-a-hidden-maze`
...
- Figures: none
- Gates: verify ✓ (7/7 languages, 19/19 cases each) · compatibility ✓ (manual proof, same method as 1778: both source solutions 19/19) · stale ✓ · overlap ✓ · check: **known harness lag** (same two items as 1778's report) · sandbox pending (batch)

### Notes

- Everything in 1778's notes applies verbatim: the shard-path compatibility false positive (exemplar reproduces it), the `gen_starters.py` `MazeController` table entry, and the no-imports Go wrapper constraint.
