## 361 — Shortest Path with Alternating Colors

- New id / title / slug: 361 / Alternating Color Distances / `alternating-color-distances`
...
- Figures: none
- Gates: check ✓ (bundle shape; central tree run pending) verify ✓ (7/7 languages, 18/18 cases) sandbox n/a compatibility ✓ stale ✓ overlap ✓
