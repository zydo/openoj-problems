## 121 — Range Sum Query - Immutable

- New id / title / slug: 121 / Static Range Sums / `static-range-sums`
...
- Family naming decided up front for the four range-sum problems:
  **Static/Mutable × Range/Region Sums** — `0121_static-range-sums`,
  `0122_static-region-sums`, `0307_mutable-range-sums`,
