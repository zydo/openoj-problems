...
- New id / title / slug: 2245 / Most Trailing Zeros on a One-Bend Path / `most-trailing-zeros-on-a-one-bend-path`
...
- check.py's static tier currently fails 18 checks in other agents' bundles
  (0547_count-graph-components, 0773_fewest-tile-slides, 0881_fewest-lift-trips,
