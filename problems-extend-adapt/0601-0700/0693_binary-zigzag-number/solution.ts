...
// 2^(k+1) - 1 — the one shape whose successor shares no bit with it, so a
// single AND with x + 1 decides the answer. x + 1 reaches exactly 2^31,
// still exact as a double; & applies its 32-bit conversion to both sides.
