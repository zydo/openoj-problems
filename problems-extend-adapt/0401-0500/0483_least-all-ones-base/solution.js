 ...
 * @return {string}
 */
var leastAllOnesBase = function (n) {
    // BigInt, not Number: the input reaches 10^18, past the 2^53 mark
    // where a JS number stops representing integers exactly.
...
function baseForLength(value, m) {
    let hi = 2n;
