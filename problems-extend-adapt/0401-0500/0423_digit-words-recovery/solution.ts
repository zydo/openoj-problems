// Order never matters: the input is a shuffled multiset of letters, so one
// counting pass fixes every letter count there is to know.
function recoverDigitWords(s: string): string {
    ...
    const digits: number[] = new Array(10).fill(0);
    digits[0] = counts.z || 0;
    digits[2] = counts.w || 0;
    digits[4] = counts.u || 0;
    digits[6] = counts.x || 0;
