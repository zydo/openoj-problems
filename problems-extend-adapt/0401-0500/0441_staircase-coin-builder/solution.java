class Solution {
    ...
    public int completeStaircaseRows(int n) {
        ...
        // multiply two numbers near n/2, so the search runs in long: the
        // product peaks near 1.2e18, beyond int range but inside 64 bits.
        long lo = 1;
        long hi = n;
        while (lo <= hi) {
            long mid = (lo + hi) / 2;
