# Solutions — Widest Step Around The Ring
...
For `[6,2,9]` the interior edges contribute |6-2| = 4 and |2-9| = 7,
while the wraparound edge contributes |9-6| = 3, so the middle pair
wins. Values are
