# Solutions — Rank Features by Mentions
...
Membership is whole-word equality, not substring containment: a
response word of `"locker"` does not make `"lock"` popular. Because
