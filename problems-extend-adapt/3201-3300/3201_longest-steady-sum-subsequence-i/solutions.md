# Solutions — Longest Steady-Sum Subsequence I
...
four sweeps is the answer, which agrees with Example 1's `[2, 3, 4, 5, 8]` coming from the
alternating shapes rather than the monotone ones.
