# Solutions — Longest Climb Through A Pinned Point

## Split and binary-search the LIS

The pinned point `coordinates[k]` cuts every candidate climb into three pieces: a
...
all: any climb through them would need a step where x or y fails to grow.
