# Solutions — Longest Smooth Subsequence

## One DP value per ending letter

The classic subsequence DP — "longest smooth chain ending at index `i`" —
...
Processing characters left to right with `best[c]` = the longest smooth
