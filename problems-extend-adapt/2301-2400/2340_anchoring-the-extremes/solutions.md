# Solutions — Anchoring the Extremes
...
to reach the front, `n - 1 - p` to reach the back. The cheapest anchored
...
anchored and returns 0 through the same arithmetic, since `i == j == 0` and
