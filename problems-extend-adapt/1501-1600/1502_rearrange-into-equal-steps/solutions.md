# Solutions — Rearrange Into Equal Steps

## Sort, then check consecutive gaps

An evenly spaced sequence is, by definition, already in sorted order once
...
constant-step sequence. A two-element array always succeeds trivially, since
a single gap is always "constant."
