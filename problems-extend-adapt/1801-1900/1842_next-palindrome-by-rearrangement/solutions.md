# Solutions — Next Palindrome By Rearrangement
...
palindrome exists and the answer is `""` (example 3's `"11211"`, whose
half `"11"` cannot grow). Otherwise swap `half[i]` with the smallest
