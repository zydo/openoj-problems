# Solutions — Counting Balanced Substrings II

## Prefix balances over one period

A balanced substring has equal vowel and consonant counts — the prefix
...
substring is balanced precisely when its ending balances agree and its
