...
return an equivalent stage (Example 3), a single full batch goes straight
to `fn` (Example 1), and split batches behave the same wherever their
boundaries fall (Example 2).
