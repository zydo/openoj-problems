...
// fibonacciStream with no arguments and steps the returned generator exactly
...
class StepCase {
    ...
    // infinite.
    drive(fibonacciStream) {
        const iterator = fibonacciStream();
        if (typeof iterator?.next !== "function") {
            throw new Error("fibonacciStream must return a generator");
        }
