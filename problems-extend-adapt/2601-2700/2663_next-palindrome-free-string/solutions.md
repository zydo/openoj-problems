# Solutions — Next Palindrome-Free String
...
shorter one nested around its center (hint 1), so a string is palindrome-free
...
To get the smallest palindrome-free successor we bump exactly one position. Scanning
