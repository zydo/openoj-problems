# Solutions — Fewest Seeds to Redden the Triangle

## Four-Row Construction

The construction follows the hint's four-rows-at-a-time, bottom-up
shape directly. Rows are grouped into bands of four counted from the
