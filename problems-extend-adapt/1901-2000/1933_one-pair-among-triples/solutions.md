# Solutions — One Pair Among Triples

A decomposition into uniform pieces is governed by the lengths of
...
stay inside one uniform block, so the string splits into maximal runs
