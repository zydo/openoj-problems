# Solutions — The Best Total From K Ordered Pairings
...
Let dp[t][a][b] be the largest total of exactly t pairs whose indices
...
identically 0 and the answer is dp[k][n][m], always reachable because
k <= min(n, m). With negative values (Example 3) the exact count matters:
