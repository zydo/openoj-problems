class CountMinTree {
    constructor(n) {
        ...
        this.inf = n + 1;
        this.count = new Array(2 * this.size).fill(0);
        this.minimum = new Array(2 * this.size).fill(this.inf);
    }

    update(position, active, mth = 0) {
 ...
 * @return {number}
 */
var countQuotaSubarrays = function (nums, k, m) {
    const n = nums.length;
