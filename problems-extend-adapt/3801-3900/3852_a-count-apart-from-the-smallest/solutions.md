# Solutions — A Count Apart From The Smallest
...
qualifying `y`, matching Example 1, where 4 appears twice and the first
value with another frequency is 6. If the walk exhausts, every value
