// Frame = [node, state, left subtree sum, right subtree sum]; state counts
// the children still to visit: 0 = left pending, 1 = right pending, 2 =
// ready to sum the node itself.
type Frame = [TreeNode, number, number, number];
