// Both criteria are about totals the record reveals day by day — how many
// absences have piled up, and how long the current streak of consecutive
// lates has grown — so one sweep decides everything.
function meetsAttendanceStandard(s: string): boolean {
    let absents = 0;
    let lates = 0;
