var gatedClimbWays = function (n, parent, gates, queries) {
    ...
    const matrices = Array.from({ length: levels }, () => Array.from({ length: n }, () => [1, 0, 0, 1]));
