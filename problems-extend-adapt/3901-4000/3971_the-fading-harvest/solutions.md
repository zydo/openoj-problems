# Solutions — The Fading Harvest

The solution finds the cutoff gain by binary search and sums the selected
arithmetic-sequence terms directly.

## Binary search over the collected-gain threshold

For a positive threshold `g`, plot `i` contributes
...
Every gain strictly above the cutoff must be collected. Their sums are computed
