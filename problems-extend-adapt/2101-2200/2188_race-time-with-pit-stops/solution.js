 ...
 * @return {number}
 */
var fastestRaceTime = function (tires, changeTime, numLaps) {
    ...
    // run length is tiny. Totals stay far below Number.MAX_SAFE_INTEGER
    // for any optimal plan, but the per-tire scan is capped explicitly.
