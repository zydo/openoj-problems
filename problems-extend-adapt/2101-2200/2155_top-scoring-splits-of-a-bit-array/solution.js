 ...
 * @return {number[]}
 */
var bestSplitIndices = function (nums) {
    ...
    // O(1). Scores never exceed n = 10^5, far below Number's 2^53
    // ceiling, so plain arithmetic stays exact. The sweep emits indices
    // ascending.
