# Solutions — Pyramid Plots in a Field
...
Run the same recurrence bottom-to-top for regular pyramids and top-to-bottom for inverted pyramids. Only the previous processed row is needed in each pass.
