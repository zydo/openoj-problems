class Solution {
    ...
    public int movesToCatch(int a, int b, int c, int d, int e, int f) {
        ...
        if (c - e == d - f || c - e == f - d) {
            boolean onDiag = a - c == b - d || a - c == d - b;
            boolean inSpan = a - e == b - f || a - e == f - b;
            boolean between = (c < a && a < e) || (e < a && a < c);
