// The answer is 1 or 2. It is 1 exactly when a white piece already attacks
// the queen through an unobstructed line; the other white piece is the only
// thing that can stand between.
func movesToCatch(a, b, c, d, e, f int) int {
	...
	if c-e == d-f || c-e == f-d {
		onDiag := a-c == b-d || a-c == d-b
		inSpan := a-e == b-f || a-e == f-b
		between := (c < a && a < e) || (e < a && a < c)
