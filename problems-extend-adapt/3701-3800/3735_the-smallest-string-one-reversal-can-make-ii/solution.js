 ...
 * @return {string}
 */
var smallestAfterOneReversal = function (s) {
    const n = s.length;
    ...
    const pw1 = new Array(n + 1).fill(1),
        pw2 = new Array(n + 1).fill(1);
    const hs1 = new Array(n + 1).fill(0),
        hs2 = new Array(n + 1).fill(0);
    const ht1 = new Array(n + 1).fill(0),
        ht2 = new Array(n + 1).fill(0);
    let g1 = 0,
        g2 = 0,
        u1 = 0,
        u2 = 0;
