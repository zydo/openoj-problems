...
class IntervalSummary:
    ...
    `addValue` binary-searches the starts for the value's slot, then repairs
    at most the two neighboring intervals; `currentIntervals` hands out a copy.
    """
    ...
    def currentIntervals(self) -> List[List[int]]:
