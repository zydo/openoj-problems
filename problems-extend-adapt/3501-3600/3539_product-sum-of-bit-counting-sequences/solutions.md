# Solutions — Product Sum Of Bit-Counting Sequences
...
sequences, so every qualifying sequence is counted once, with its own
array product. A useful pruning falls out of the same counting: the set-bit count
