# Solutions — Fewest Bumps To Level The Branches
...
nodes whose gap jumps, which by the monotonicity is the same set the
hints describe as the nodes whose required raise differs from their
parent's.
