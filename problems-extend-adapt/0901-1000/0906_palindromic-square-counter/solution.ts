// A TS number is not exact past 2^53 and the squares reach 10^18, so the
// roots, squares, and both bounds live in bigint; only the half counter and
// the count stay numbers.
function countPalindromicSquares(left: string, right: string): number {
...
function isPalindrome(value: bigint): boolean {
