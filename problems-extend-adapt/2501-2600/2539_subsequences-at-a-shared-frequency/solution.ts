function countSharedFrequency(s: string): number {
    ...
    // exceed 2^53, so every multiply runs in BigInt; table indices stay
    // plain numbers and the final residue fits a number again.
