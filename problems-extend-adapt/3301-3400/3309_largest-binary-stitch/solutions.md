# Solutions — The Largest Binary Stitch
...
already shows a plain descending sort going wrong — `[5, 2, 1]`
concatenates `"101" + "10" + "1"` = 45, while the winning `[1, 5, 2]`
concatenates `"1" + "101" + "10"` = 54. Six candidates are cheap enough
