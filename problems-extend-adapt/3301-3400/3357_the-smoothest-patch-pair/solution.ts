...
// each run leaves for y. All interval values stay within 4e9 in magnitude
// — far below 2^53, so Number arithmetic is exact.
function smoothestPatchPair(nums: number[]): number {
