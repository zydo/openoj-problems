# Solutions — Houses On A Ring Road II

## Beacon laps with progressive closing

An open door is the only landmark the ring offers, so treat the open
...
million only in pathological all-open rings at `k = 10⁵`, and at most
