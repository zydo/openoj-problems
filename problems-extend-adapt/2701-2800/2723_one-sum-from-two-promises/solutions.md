# Solutions — One Sum From Two Promises
...
resolves precisely when both inputs have resolved — Example 1's 45 ms and
80 ms timers land at their own pace, while only the slower one gates when
`42` is produced.
