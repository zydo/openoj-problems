# Solutions — Houses On A Ring Road
...
`k` close-and-move pairs every door on the ring is closed.

Reopening the door we now stand at plants the ring's single landmark —
