# Solutions — Cancelling A Deferred Call

A cancellable deferred call is one pending timer captured in a closure and
a cancel function that clears it. Because the judge replays each case on a
...
`deferrable(fn, args, t)` schedules one setTimeout for t milliseconds
