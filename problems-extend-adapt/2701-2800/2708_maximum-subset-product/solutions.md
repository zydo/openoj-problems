# Solutions — Maximum Subset Product

A pick is an arbitrary non-empty subset, so the whole task is deciding
...
element forces the product to zero, and any product of kept nonzeros has
...
is the lone negative just dropped, and the best pick is the largest single
