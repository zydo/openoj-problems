...
class Solution:
    def keepSingles(self, head: Optional[ListNode]) -> Optional[ListNode]:
        ...
        tail = dummy
        while tail.next:
            if tail.next.next and tail.next.next.val == tail.next.val:
                ...
                value = tail.next.val
                while tail.next and tail.next.val == value:
