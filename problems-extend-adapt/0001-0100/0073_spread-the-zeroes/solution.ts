function spreadZeroes(matrix: number[][]): number[][] {
    ...
    for (const value of matrix[0]) firstRowZero = firstRowZero || value === 0;
    let firstColZero = false;
    for (const row of matrix) firstColZero = firstColZero || row[0] === 0;
