// The grid doubles as the DP table: after the scan, grid[i][j] holds not
// the cell's own value but the cheapest path sum from (0, 0) reaching it,
// so no second table is ever allocated.
