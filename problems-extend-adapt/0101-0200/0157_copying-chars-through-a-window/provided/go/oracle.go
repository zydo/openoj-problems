...
func NewCharSource(values []any, budget int64) *CharSource {
	...
	return &CharSource{content: content, budget: budget, position: 0}
}

func (file *CharSource) Read4(buf4 []string) int {
	if file.budget <= 0 {
