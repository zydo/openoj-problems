...
// citations[i] or more: the test citations[i] >= n - i asks whether h = n - i
// is achievable. citations never decreases while n - i strictly does, so the
// test reads false ... false, true ... true along the array — bisect for its
// first true.
