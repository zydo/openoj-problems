...
// intersection, since everything outside the intersection is already
// counted exactly once.
func totalCoveredArea(ax1 int, ay1 int, ax2 int, ay2 int, bx1 int, by1 int, bx2 int, by2 int) int {
