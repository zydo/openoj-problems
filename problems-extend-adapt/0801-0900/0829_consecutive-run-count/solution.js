 ...
 * @return {number}
 */
var countConsecutiveRuns = function (n) {
    ...
    // n - L*(L-1)/2 is a positive multiple of L. The smallest sum of L
    // terms is 1 + 2 + ... + L = L*(L+1)/2: once that minimum passes n no
    // run fits, and below it the remainder is at least L, so divisibility
