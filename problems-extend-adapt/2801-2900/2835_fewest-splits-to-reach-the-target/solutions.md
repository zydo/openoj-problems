# Solutions — Fewest Splits To Reach The Target
...
j − b splits, because each split removes one element and leaves two at
...
O(n) counting pass, well inside the limits; counts and split totals stay
