# Solutions — Spelled By First Letters

## Join first characters and compare

The spelling is defined by an explicit recipe: read `words` from left to
...
case of repeated initials, where example 2's words really do spell "sms"
against the shorter "sm" — the comparison still answers false. No guard is
...
comparison scans at most 100 characters. The collected spelling needs
one stored character per word.
