# Solutions — Distinct Powers of Three
...
answer is `true` once the digits run out: `13` peels `1, 1, 1` (it is
`111₃ = 3⁰ + 3¹ + 3²`) while `15` peels `0, 2, 1` (`120₃`, the 2 kills it,
and reusing `3¹` twice is exactly what distinctness forbids).
