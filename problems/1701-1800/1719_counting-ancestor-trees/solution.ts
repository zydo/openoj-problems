// Values are bounded by 500, so the adjacency rides as a flat 501x501
// byte matrix indexed by the values themselves.
function countReconstructions(pairs: number[][]): number {
