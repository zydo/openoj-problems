impl Solution {
    pub fn longest_two_case_substring(s: String) -> String {
        ...
        for i in 0..b.len() {
            ...
            if !b.contains(&other) {
                let left = Self::longest_two_case_substring(s[..i].to_string());
                let right = Self::longest_two_case_substring(s[i + 1..].to_string());
