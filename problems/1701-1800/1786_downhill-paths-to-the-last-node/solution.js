 ...
 * @return {number}
 */
var countDownhillPaths = function (n, edges) {
    // Dijkstra from node n fixes dist[x] = dist(x), the shortest distance to node n; stale
    // heap entries are skipped. A downhill path strictly decreases that
