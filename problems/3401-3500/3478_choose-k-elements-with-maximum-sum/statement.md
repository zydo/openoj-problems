...
Sort nums1 together with its corresponding nums2 values by nums1.

### Hint 2

A min-heap can track the top k values of nums2 as you sweep the indices in sorted order.

### Hint 3

Process equal nums1 values as a group: none of them may use another in the same group.
