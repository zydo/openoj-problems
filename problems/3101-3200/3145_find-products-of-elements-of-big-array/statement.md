...
Find a way to calculate f(n, i) which is the total number of numbers in [1, n] when the i-th bit is set in O(log(n)) time.
...
Use a similar way to find the product (we only need to save the sum of exponents of powers of 2).
