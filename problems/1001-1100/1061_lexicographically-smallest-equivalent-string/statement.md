...
Model these equalities as edges of a graph over the 26 lowercase letters.

### Hint 2

Group each connected component and assign every node of the component to the lexicographically lowest character in it (union-find makes this easy).

### Hint 3

Finally convert each character of baseStr using the precomputed mapping.
