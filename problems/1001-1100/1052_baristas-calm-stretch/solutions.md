# Solutions — The Barista's Calm Stretch

## Sliding window over the grumpy minutes

First sum the customers in every minute where the barista is already
calm — that baseline is happy no matter what. Then slide a window
