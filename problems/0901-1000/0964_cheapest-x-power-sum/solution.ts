...
// operator, so one is deducted at the end. The running totals stay in the
// low thousands, exact as doubles far below 2^53; Infinity marks the carry
// state unreachable before the first digit.
