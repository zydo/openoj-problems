class Solution {
    ...
    public int countXorSlices(int[] nums, int target1, int target2) {
        ...
        // any pre-reduction sum below 2^31; the buckets are long anyway.
        ...
        long[] endsT1 = new long[1 << 17];
        long[] endsT2 = new long[1 << 17];
        endsT2[0] = 1;
        int p = 0;
        long curT1 = 0;
        long curT2 = 0;
