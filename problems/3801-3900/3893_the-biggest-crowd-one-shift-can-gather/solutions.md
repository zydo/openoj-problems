# Solutions — The Biggest Crowd One Shift Can Gather

A valid crowd is anchored by one member who interacts with everyone else, so the
largest crowd for a fixed anchor `i` is simply `i` together with every interval
