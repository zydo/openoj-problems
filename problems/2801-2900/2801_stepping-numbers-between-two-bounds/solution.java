...
class Solution {
    ...
    public int countSteppers(String low, String high) {
    ...
    private static int countUpTo(String bound) {
        if (bound.equals("0")) return 0;
        int n = bound.length();
    ...
    private static String decrement(String value) {
        ...
        return new String(digits, first, digits.length - first);
    }
}
