// Problem-provided case runner for 2822 an-object-turned-inside-out. Assembled
...
class FlipCase {
    ...
    // solution's flipMapping, remember the structural verdict.
    check(solution) {
        const actual = solution.flipMapping(this.buildInput());
