...
For a given index, find the largest subarray such that the given index is the minimum element.

### Hint 3

Use a monotonic stack to get the next and previous smaller element for every index.
