...
`1 <= i < n`, and moving clockwise from the `n`th friend brings you to the
`1`st friend.
...
Maintain a circular list of the people who are still in the circle and the current person you are standing at.

### Hint 3

In each turn, count k people clockwise and remove the last person counted from the list.
