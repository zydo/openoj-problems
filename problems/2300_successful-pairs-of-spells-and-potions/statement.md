...
If a spell and potion pair is successful, then the spell and all stronger potions are successful too.

### Hint 2

For each spell, we need the potion with the least strength that still forms a successful pair.

### Hint 3

Sort the potions by strength and use binary search per spell.
