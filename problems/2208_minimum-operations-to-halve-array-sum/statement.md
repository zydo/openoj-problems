...
choose any number from `nums` and reduce it to exactly half the number.
...
Use a heap (priority queue) to repeatedly fetch the current maximum efficiently.

### Hint 3

Keep halving the maximum and count operations until the total reduction reaches at least half of the initial sum.
