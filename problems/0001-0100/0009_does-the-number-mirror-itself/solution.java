class Solution {
    ...
    public boolean mirrorsItself(int x) {
        ...
        // Peel digits off the tail of x onto reversedHalf until the halves
        ...
        // digit sits in reversedHalf's last place and is dropped by / 10.
