...
Return _the minimum initial amount of energy you will need to finish all the
tasks_.
...
We can easily figure that f(x): whether x energy solves this array is monotonic, so binary search is doable.

### Hint 2

There is also a direct greedy: figure out a sorting pattern for the tasks.
