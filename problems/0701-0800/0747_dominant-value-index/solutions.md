# Solutions — Dominant Value Index
...
is Example 2's story: 5 falls short of twice 4, so no index is returned. A
runner-up of 0 can never fail the test, so a leader standing over nothing but
zeros always wins outright, and in Example 1, 10 clears twice its own
runner-up, 5, exactly.
