class Solution {
    ...
    public String nextPalindromeFree(String s, int k) {
        ...
        for (int i = chars.length - 1; i >= 0 && pivot == -1; i--) {
            for (char cand = (char) (s.charAt(i) + 1); cand < limit; cand++) {
        ...
        for (int j = pivot + 1; j < chars.length; j++) {
