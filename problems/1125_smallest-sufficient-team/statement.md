...
people. The `i`-th person `people[i]` contains a list of skills that the
person has.
...
For each person, for each set of skills, update the minimum set of people needed to perform that set of skills.
