...
Use a trie to build the folder structure.

### Hint 2

Utilize hashing to identify duplicate folder structures.

### Hint 3

A folder with no subfolders can never be a duplicate of another folder.
