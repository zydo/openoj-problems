...
Loop through the array and pop elements from the heap if the condition xj - xi > k holds, where j is the current index and i is the point on top of the queue.
