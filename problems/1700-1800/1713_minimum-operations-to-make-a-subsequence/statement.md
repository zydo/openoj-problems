...
The problem can be reduced to computing the Longest Common Subsequence between both arrays.
...
Then the problem is converted to finding the Longest Increasing Subsequence in the second array, which can be done in O(n log n).
