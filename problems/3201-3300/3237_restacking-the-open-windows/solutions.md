# Solutions — Restacking The Open Windows
...
`windows = [1,2,3,4]`, `queries = [2,4,2]` the reverse walk writes `2`,
then `4`, skips the older duplicate `2`, and the second pass appends `1`
and then `3`, giving `[2,4,1,3]` as in the example.
