...
Think about how the count of each individual integer affects the final answer.
...
A value XORed with itself an even number of times cancels out, so only the arrays of odd length contribute their overall XOR to the answer.
