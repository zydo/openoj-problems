# Solutions — Stacked Corner Rectangles II

## Minimum prefix rectangle

A stamp `[a, b]` never touches a scattered set of cells: it increments
...
stamps whose rectangle covers it, and the maximum can only sit where
