// deferrable schedules exactly one delayed execution and hands back a
...
function deferrable(fn: (...args: any[]) => unknown, args: any[], t: number): CancelFn {
...
class Solution {
    run(deferralCase: DeferralCase): void {
        deferralCase.drive(deferrable);
    }
}
