...
In lexicographical order, elements to the left have higher priority than those that come after. Build the answer incrementally from left to right.

### Hint 2

Keep a stack: pop the top while it is larger than the incoming element and enough elements still remain to fill the subsequence up to size k.
