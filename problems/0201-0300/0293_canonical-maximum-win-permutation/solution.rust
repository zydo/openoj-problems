impl Solution {
    pub fn canonical_winning_permutation(available: Vec<i32>, opponents: Vec<i32>) -> Vec<i32> {
        let mut values = available.clone();
        ...
        let mut result = Vec::with_capacity(opponents.len());
