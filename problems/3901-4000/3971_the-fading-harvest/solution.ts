function bestFadingHarvest(value: number[], decay: number[], m: number): number {
    ...
    if (count(1n) <= bigM) return Number(total(1n));
    let maximum = 0;
