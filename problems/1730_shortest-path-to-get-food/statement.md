...
Keep the current number of steps as part of the state in the queue.

### Hint 3

The first time you reach a food cell, return the number of steps as the answer.

### Hint 4

If the queue empties before you reach any food, return -1.
