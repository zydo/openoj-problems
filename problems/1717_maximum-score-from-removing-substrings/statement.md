...
- Remove the "ab" underlined in "cdbcbbaaab". Now, s = "cdbcbbaa" and 4
  points are added to the score.
- Remove the "ba" underlined in "cdbcbbaaa". Now, s = "cdbcba" and 5 points
...
It is always more optimal to completely remove one type of substring before the other - start with whichever of x and y is larger.

### Hint 2

You can use a stack to handle the erasures, then run the same pass for the other substring on the leftovers.
