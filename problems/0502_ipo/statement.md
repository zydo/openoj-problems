...
Greedy choice: at each step, among all projects you can currently afford, pick the one with the largest profit.

### Hint 2

Sort the projects by required capital and sweep a pointer forward as your capital grows; add newly affordable profits to a max-heap.

### Hint 3

Stop early when fewer than k projects are chosen but nothing is affordable, or when you have picked all n projects.
