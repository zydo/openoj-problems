# Solutions — Mirror-Free Rearrangement

## Sort, then push the right half off its mirrors

Any sequence of swaps permutes `s` freely, so the task reduces to finding
the lexicographically smallest mirror-free arrangement among all
rearrangements of its letters — or reporting that none exists. Lexicographic order is decided
