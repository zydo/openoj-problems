...
to right (from the most significant digit to the least significant digit),
...
Convert the bounds to base b and use digit dynamic programming over those digits.

### Hint 2

The answer is count(r) - count(l - 1); track whether the current prefix already equals the bound (tight) and the last digit chosen.
