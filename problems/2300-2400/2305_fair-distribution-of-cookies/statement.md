...
We have to give each bag to one of the children. Enumerate all of the possibilities with recursion.

### Hint 2

Keep track of the current number of cookies each child has; once all the bags have been distributed, take the maximum over the children.

### Hint 3

Prune branches where the running maximum already meets or exceeds the best answer found so far, and skip children with identical current totals.
