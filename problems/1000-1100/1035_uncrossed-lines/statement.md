...
Think dynamic programming. Given an oracle dp(i, j) that tells us how many lines from nums1[i:] and nums2[j:] are uncrossed, can we write this as a recursion?

### Hint 2

If nums1[i] == nums2[j], matching them is always at least as good as skipping either element.

### Hint 3

This is the longest common subsequence of the two arrays in disguise.
