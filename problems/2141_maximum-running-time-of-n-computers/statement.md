...
A time t is feasible exactly when the total charge sum(min(battery, t)) reaches n * t, since each battery contributes at most t minutes across the computers.

### Hint 3

Use binary search on the answer t in the range [0, sum(batteries) / n].
