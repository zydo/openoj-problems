class Solution {
    ...
    public TreeNode dropZeroOnlySubtrees(TreeNode root) {
        ...
        root.left = dropZeroOnlySubtrees(root.left);
        root.right = dropZeroOnlySubtrees(root.right);
        ...
        // null. Depth is bounded — at most 200 nodes, so a chain nests
        // at most 201 frames, nothing against this judge's 512k Java
        // thread stack.
