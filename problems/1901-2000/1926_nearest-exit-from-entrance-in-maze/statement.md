...
(represented by `'.'`) and walls (represented by `'+'`). You are also given
...
Try using a Breadth First Search from the entrance, stopping the first time you reach a border cell that is not the entrance.
