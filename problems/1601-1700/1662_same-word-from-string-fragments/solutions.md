# Solutions — Same Word From String Fragments
...
between the two lists: `["car", "go"]` and `["c", "argo"]` walk through
`cargo` in different footstep patterns while visiting exactly the same characters.
