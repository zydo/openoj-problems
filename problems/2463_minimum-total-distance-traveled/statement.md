...
robot reaches a factory that did not reach its limit, the factory repairs the
robot, and it stops moving.
...
Sort the robots and the factories by their positions.

### Hint 2

After sorting, each factory repairs some contiguous subsegment of the robots.

### Hint 3

Use dynamic programming over the first i robots and the first j factories, assigning a contiguous block of robots to each factory.
