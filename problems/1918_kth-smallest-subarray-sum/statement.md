...
Given a value x, count how many subarrays have a sum of at most x using a sliding window over the strictly positive array.

### Hint 2

That count is non-decreasing in x, so binary search for the smallest x whose count reaches k.
