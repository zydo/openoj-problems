...
Use DFS, BFS, or union-find to determine the number of isolated computer clusters (connected components).

### Hint 3

The answer is the number of components minus one, or -1 when there are fewer than n - 1 cables.
